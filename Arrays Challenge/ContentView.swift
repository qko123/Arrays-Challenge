...
struct ContentView: View {
     ...
     ************************************/
    @State private var myFavoriteMovies : [String]? = ["Joker", "Top Gun Maverick", "Knives Out", "Barbarian", "Hereditary"]
                ...
                if s1Check == 0 {
                    Button("Test Stretch 1") {
                        ...
                        if var myFavoriteMovies = myFavoriteMovies {
                            ...
                            myFavoriteMovies.insert("Dont Worry Darling", at: 1)
                            myFavoriteMovies.append("Heist")
                            myFavoriteMovies.insert("Guns Shooty Shoot", at: 2)
                            /*********************************
                             * End of Stretch 1
                             ***********************************/
